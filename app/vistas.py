...
class VistaGrupo:
    ...
    def paint(self):
        ...
        for indice, tipo in enumerate(TipoEntrada):
            locate(self.x, self.y + 3 + indice,  f'{tipo.name:.<14s}{tipo.value:5.2f}    {self.grupo.cantidad_entradas_por_tipo(tipo):2d}{self.grupo.subtotal_tipo(TipoEntrada.BEBE):7.2f}')
